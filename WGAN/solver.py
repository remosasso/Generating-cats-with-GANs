...
class Solver(object):
    ...
    def test(self):
        ...
        for iter_time in range(num_iters):
            ...
            self.model.plots(imgs, iter_time, self.test_out_dir, self.current_time)
    ...
    def sample(self, iter_time):
        if np.mod(iter_time, self.flags.sample_freq) == 0:
            ...
            self.model.plots(imgs, iter_time, self.sample_out_dir, self.current_time)
